...
public class LapDetectionUtil {
    ...
    public static List<Lap> getLaps(List<LocationData> locationData, GoogleMap googleMap, List<Polyline> polylines) {
        ...
        if(startFinishPoints != null) {
            ...
            MapDrawingUtil.drawLine(googleMap, finishLine);
            ...
            if(laps.isEmpty()) {
                ...
                MapDrawingUtil.drawAllCoordinates(googleMap, locationData, polylines);
            }
            return laps;
        } else {
    ...
    public static List<LatLng> getFinishLine(List<LocationData> locationData, List<Integer> indexArray, double lineLength) {
        LatLng centerLatLng = LapDetectionUtil.getAveragePoint(locationData, indexArray);
        LatLng directionVector = LapDetectionUtil.getAverageDirectionVector(locationData, indexArray);
